 ...
 * the License.
 ******************************************************************************/
package com.ureport.ureportkeep.core.export.excel.low;
...
public class CellStyleContext {
	...
	private BorderStyle getBorderStyle(Border border){
		if(border.getStyle().equals(com.ureport.ureportkeep.core.definition.BorderStyle.solid)){
			return BorderStyle.THIN;
		}else if(border.getStyle().equals(com.ureport.ureportkeep.core.definition.BorderStyle.dashed)){
			return BorderStyle.DASHED;
		}else if(border.getStyle().equals(com.ureport.ureportkeep.core.definition.BorderStyle.doublesolid)){
