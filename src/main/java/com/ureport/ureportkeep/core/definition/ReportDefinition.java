    ...
    private String buildStyle() {
        ...
        for (CellDefinition cell : cells) {
            ...
            Boolean bold = cellStyle.getBold(),
					italic = cellStyle.getItalic(),
					underline = cellStyle.getUnderline() == null ? false : cellStyle.getUnderline(),
					dropLine = cellStyle.getDropLine() == null ? false : cellStyle.getDropLine();
            if (bold != null && bold) {
			...
			if (underline && dropLine) {
				sb.append("text-decoration:line-through underline;");
			} else {
				if (underline) {
