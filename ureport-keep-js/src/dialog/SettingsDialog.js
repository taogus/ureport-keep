...
export default class SettingsDialog {
    ...
    show(context) {
        ...
        if (this.paper.watermarkColor && this.paper.watermarkColor.length === 3) {
            let colorStr = this.paper.watermarkColor.join(",");
            this.colorContainer.colorpicker("setValue", "rgb(" + colorStr + ")");
        }
